...
import { ShoppingCart, ArrowLeft, CreditCard, ShieldCheck, Truck, Package } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center text-center px-6">
        <div className="max-w-md">
          ...
          <h2 className="text-4xl font-black tracking-tighter uppercase mb-4">Your bag is empty</h2>
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12 lg:mb-16">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-gray-600 mb-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em]">Shopping Bag</span>
            </div>
            <h1 className="text-5xl font-black tracking-tighter uppercase leading-none">
              Checkout
            </h1>
          </div>
          <p className="text-gray-600 font-bold uppercase text-[10px] tracking-widest border-b-2 border-black pb-1">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-gray-50 shadow-sm">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-gray-600">{benefit.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            <div className="bg-white rounded-[2.5rem] p-8 lg:p-10 border border-gray-50 shadow-xl shadow-gray-200/40">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between text-sm font-medium text-gray-600">
                  <span className="uppercase tracking-widest text-[10px] font-black">Estimated Tax</span>
                  <span className="font-bold text-black">₹0</span>
                </div>
                <div className="flex justify-between text-sm font-medium text-gray-600">
                  <span className="uppercase tracking-widest text-[10px] font-black">Shipping</span>
              ...
              <div className="border-t border-black pt-6 flex justify-between items-end mb-10">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-gray-600">Total Amount</p>
                  <p className="text-4xl font-black tracking-tighter mt-1">₹{totalPrice.toLocaleString()}</p>
                </div>
              </div>
              ...
              <Link to="/products" className="block text-center text-[10px] font-black uppercase tracking-widest text-gray-600 hover:text-black transition-colors">
                Continue Shopping
              </Link>
            </div>
          </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-2xl border-t border-gray-100 p-6 z-50">
        <div className="max-w-md mx-auto flex items-center justify-between gap-6">
          <div className="flex flex-col">
            <span className="text-[10px] font-black uppercase text-gray-600 tracking-tighter">Subtotal</span>
            <span className="text-2xl font-black leading-none mt-1">₹{totalPrice.toLocaleString()}</span>
          </div>
