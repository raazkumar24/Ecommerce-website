      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 md:pt-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-4 md:space-y-6 lg:sticky lg:top-8 order-2 lg:order-1">
            {/* Create Card */}
            <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 border border-gray-50 shadow-sm transition-all hover:shadow-xl">
          ...
          <div className="lg:col-span-8 order-1 lg:order-2">
            <div className="bg-white rounded-[2rem] md:rounded-[3rem] border border-gray-50 shadow-sm overflow-hidden">
                      ...
                      {editingId === category._id ? (
                        ...
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-3 md:gap-6 min-w-0">
                            <div className="w-10 h-10 md:w-12 md:h-12 bg-gray-50 rounded-xl md:rounded-2xl flex-shrink-0 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-all duration-500">
