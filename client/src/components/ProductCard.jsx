...
const ProductCard = ({ product, index }) => {
  ...
  return (
    <Link
      ...
      style={{ animationDelay }}
    >
      <div className="relative h-full bg-white rounded-4xl p-3 pb-5 border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1.5 transition-all duration-500 flex flex-col">
        ...
        <div className="px-1 flex flex-col flex-1">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest truncate max-w-[60%]">
